import{_ as e,r as h,o as c,c as p,e as a,w as r,d as s,f as t,b as n}from"./app-es50OF96.js";const i={},m=n("h1",{id:"🎈前端资源分享",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#🎈前端资源分享","aria-hidden":"true"},"#"),s(" 🎈前端资源分享！")],-1),w=n("p",null,"主播今年找到工作了分享~",-1);function u(l,d){const o=h("font");return c(),p("div",null,[m,a(o,{color:"gray"},{default:r(()=>[s("🛠️ 建设中...")]),_:1}),w,t(" <font color=gray>Published on 2025-03-06</font> "),t(" 这是主播这几年来学习和收集的。由于主播主攻前端开发方向，对于 AI、后端方向就不瞎推送啦~ "),t(` ## 技术栈
...
以下待更新：课程、掘金/资料小册、讲座、正在学习的项目、正在做的项目、正在打算做的开源计划 `)])}const b=e(i,[["render",u],["__file","resource_share.html.vue"]]);export{b as default};
